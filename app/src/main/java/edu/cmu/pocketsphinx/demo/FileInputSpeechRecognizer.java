...
class FileInputSpeechRecognizer {

    Context context;

    FileInputSpeechRecognizer(Context context) {
    ...
    public void convertToSpeech(File wavFile) throws IOException {
        final InputStream stream = new FileInputStream(wavFile);
            ...
            protected Exception doInBackground(Void... params) {
                try {
                    ...
                    for (Segment seg : d.seg()) {
                        System.out.println("segment:" + seg.getWord() + ":" + seg.getStartFrame() + "," + seg.getEndFrame());
                    }
                } catch (IOException e) {
                    e.printStackTrace();
                }
